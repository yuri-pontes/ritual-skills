...
description: Ritual de abertura do dia. Registra o sono da noite anterior (memória fresca de manhã) e devolve o briefing do dia montado a partir do plano deixado ontem na entrevista + a agenda de hoje. Não é planejamento, é recepção. Use quando o usuário disser "check-in da manhã", "organiza meu dia", "abre meu dia", "me localiza", "bom dia organiza aí".
---

# Ritual: Check-in da Manhã

Briefing de 2 a 3 minutos. Não é planejamento (o plano foi feito ontem à noite). É receber o dia como uma quest já montada. Duas partes: capturar o sono (rápido) e devolver o dia.
