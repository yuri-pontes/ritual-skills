...
3. Apresentar só o que parece faltar, em lista curta. **Nunca escrever no log a partir das fontes sem o usuário confirmar**: o que vem das fontes é candidato, você confirma antes de gravar. Registrar só o que ele aceitar.
...
- Nunca escrever no log a partir das fontes sem confirmação. O que vem das fontes é candidato; confirma antes de gravar.
